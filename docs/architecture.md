...
Spanner is a local-first, multi-surface coding-agent workbench. This document describes the package boundaries and the run-time topology.
...
@echohello/client     WS driver + SpannerClient facade.
