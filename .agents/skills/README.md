...
| Spanner-authored, machine-only                                          | `<skill-name>/` (same as root `skills/`) |

## What does NOT go here

Spanner's curated, published skills (the ones discoverable via
`npx skills add echohello-dev/spanner`) belong in the **root** `skills/`
tree. See `../../skills/spanner/SKILL.md` for the worked example.
...
- `../../skills/spanner/SKILL.md` — the Spanner daemon skill, for comparison.
