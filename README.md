...
Spanner (née Pidex, née OpenPi) is a personal project under the [echohello](https://echohello.dev) org. Companion installer: [`hoist`](https://github.com/echohello-dev/hoist).
...
├── client/     # WS driver + SpannerClient facade (used by web, desktop, app, cli)
