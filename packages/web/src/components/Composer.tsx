  ...
  return (
    <footer className="border-t border-neutral-800 bg-neutral-900/60 px-6 py-3">
      <div className="flex gap-3">
        ...
        />
        <button
          className="rounded bg-spanner-accent px-4 py-2 text-sm font-medium text-white transition hover:bg-spanner-accent-soft disabled:opacity-40"
