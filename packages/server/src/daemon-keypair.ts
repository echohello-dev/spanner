...
export function loadOrCreateDaemonKeyPair(spannerHome: string): DaemonKeyPair {
  mkdirSync(spannerHome, { recursive: true });
  const filePath = join(spannerHome, KEYPAIR_FILENAME);
